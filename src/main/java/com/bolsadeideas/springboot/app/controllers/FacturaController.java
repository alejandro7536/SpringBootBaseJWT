...
import com.bolsadeideas.springboot.app.models.entety.ItemFactura;
...
public class FacturaController {
	...
	@GetMapping(value = "/cargar-productos/{term}", produces = { "application/json" }) // retorna un json
	...
	public String guardar(@Valid Factura factura,
		...
		if(itemId == null || itemId.length == 0) {
			model.put("titulo", "Crear Factura");
			model.put("error", "La factura debe tener lineas de productos");
			return "factura/form";
		}
